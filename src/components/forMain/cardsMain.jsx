const MainCards = () => {
  return (
    <div className="flex flex-col md:flex-row pt-10 pb-12 justify-between max-w-[1250px] m-auto gap-3 ">
      <div className="p-3 bg-[#B6E5F0] md:w-80 shadow-mdrounded-lg hover:scale-105 cursor-pointer transition-[.3s]">
      ...
      <div className="p-3  bg-[#B6E5F0] md:w-80 hover:scale-105 cursor-pointer transition-[.3s]">
